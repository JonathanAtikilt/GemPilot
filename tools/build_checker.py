...
REPO_HEALTH_SCAFFOLD: dict[str, str] = {
    "README.md": "# MVPilot Generated MVP\n\nAutogenerated repository scaffold.\n",
    "docs/BUILD_LOG.md": "# Build Log\n\n- Repository scaffold created by MVPilot.\n",
    "docs/ARCHITECTURE.md": "# Architecture\n\nGenerated MVP scaffold for hackathon demo.\n",
...
def merge_repo_health_scaffold(files: list[dict[str, str]]) -> list[dict[str, str]]:
    ...
    paths = set(merged)
    for path, content in REPO_HEALTH_SCAFFOLD.items():
        if path in merged:
            continue
