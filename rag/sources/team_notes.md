...
The Orchestrator Agent should call the RAG answer-context endpoint before deciding project scope or next action. The RAG agent should provide grounded context and short recommendations only; it should not choose the final project by itself.
