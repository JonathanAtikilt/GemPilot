...
class LiveRagMemoryAdapter:
    ...
    async def retrieve_provider_context(self, idea: str) -> list[dict[str, Any]]:
        results = await search_rag(
            query=idea,
            top_k=5,
            doc_types=["ai_provider_docs", "llm_model_docs", "llm_model_usage"],
        )
        return [r.model_dump() for r in results]
    ...
    def create_repo(
        ...
        *,
        ...
        raw_result = create_repo(
            ...
            description=repo_description or "Generated by GemPilot",
            visibility=visibility,
        ...
        if repo_status == "reused":
            success_message = "Reused your existing GitHub repository for this generated project name."
