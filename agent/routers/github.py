...
class GitHubUploadProjectRequest(BaseModel):
    ...
    commitMessage: str = "Add generated GemPilot full-stack project"
...
async def upload_project(
    ...
    repo_name = request.repoName or _repo_name_from_url(request.repoUrl) or f"gempilot-{request.projectId[:8]}"
    ...
    if request.repoPreference == "create_new_repo":
        repo_result = create_repo(
            repo_name=repo_name,
            description=request.repoDescription or "Generated by GemPilot",
    ...
    *,
    ...
    try:
        ...
        return RedirectResponse(
            service.redirect_url_for_error(
                return_to,
                "GitHub connection setup failed. Check backend logs and Supabase settings.",
            )
        )
